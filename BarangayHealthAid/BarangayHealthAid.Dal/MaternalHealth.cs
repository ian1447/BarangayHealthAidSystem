...
namespace BarangayHealthAid.Dal
{
    public class MaternalHealth
    {
        ...
        public static string UpdateMaternalHealthRecordErrorMessage;
        public static bool UpdateMaternalHealthRecordIsSuccessful;
        public static void UpdateMaternalHealthRecord(int _patient_id, string _name, string _age, string _dob, string _height, string _husband_name, string _occupation, string _address, string _contact_no, string _no_children_born_alive, string _living_children, string _abortion, string _fetal_deaths, string _type_last_delivery, string _largebabies, string _diabetes, string _previous_illness, string _allergy, string _previous_hospitalization, string _gravida, string _PARA, string _A, string _stillbirth, string _LMP, string _EDC, string _where_to_deliver, string _attended_by, string _new_born_screening_plan, string _risk_codes, string _tt1, string _tt2, string _tt3, string _tt4, string _tt5, string _urinalysis, string _hbs_antigen, string _CBC, string _RPR, string _blood_typing, string _HIV, string _prev_pregnancy_complic, string _checklist, string _vit_a_date_given, string _vit_a_prescribed, string _iron_folic_4, string _iron_folic_5, string _iron_folic_6, string _iron_folic_7, string _iron_folic_8, string _iron_folic_9, int _id)
        {
            _tt1 = _tt1 == "" ? null : _tt1;
            _tt2 = _tt2 == "" ? null : _tt2;
            _tt3 = _tt3 == "" ? null : _tt3;
            ...
            try
            {
                ...
                {
                    con.Open();
                    MySqlCommand cmd = new MySqlCommand("sp_maternal_health_record_update", con);
                    cmd.Parameters.Add(new MySqlParameter("_patient_id", _patient_id));
                    cmd.Parameters.Add(new MySqlParameter("_name", _name));
                    cmd.Parameters.Add(new MySqlParameter("_age", _age));
                    cmd.Parameters.Add(new MySqlParameter("_dob", _dob));
                    ...
                    adp.Fill(dt);
                    con.Close();
                    UpdateMaternalHealthRecordIsSuccessful = true;
                }
            }

            catch (Exception ex)
            {
                UpdateMaternalHealthRecordIsSuccessful = false;
                UpdateMaternalHealthRecordErrorMessage = ex.Message + "\nFunction : Updat Maternal Health Record";
            }
        }
