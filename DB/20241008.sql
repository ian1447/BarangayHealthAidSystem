...
insert  into `purok_family_members`(`id`,`purok_members_id`,`name`,`description`,`birthday`,`age`,`sex`,`added_by`,`added_on`) values (5,2,'Testing Edit PAPAP','Father','2024-10-08',53,'Male',1,'2024-10-01 20:56:40'),(6,2,'test anak1','Son','2024-10-02',1,'Male',1,'2024-10-01 21:00:27'),(7,2,'test Anak 2','Son','2024-10-08',23,'Male',1,'2024-10-01 21:00:37'),(8,1,'sdfg','Son','2024-10-08',234,'Male',1,'2024-10-08 09:46:38'),(9,1,'asdfzxcv','son','2024-10-10',234,'Female',1,'2024-10-08 09:46:48'),(10,1,'xzcv','sOn','2024-10-23',1,'Male',1,'2024-10-08 09:50:12');
...
BEGIN
	...
	CONCAT(UPPER(SUBSTRING(p.`description`, 1, 1)), LOWER(SUBSTRING(p.`description`, 2))) description_case FROM `purok_family_members` p 
